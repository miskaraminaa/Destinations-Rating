package miskar.ma.destinationrating.adapter;
...
public class StarAdapter extends RecyclerView.Adapter<StarAdapter.StarViewHolder>  implements Filterable {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(context, R.style.MyDialogStyle)
                        .setTitle("Tap on the stars to select your rating : ")
                        .setView(popup)
    ...
    public void onBindViewHolder(@NonNull StarViewHolder starViewHolder, int i) {
        ...
        starViewHolder.name_country.setImageResource(starsFilter.get(i).getCountry());
    }
